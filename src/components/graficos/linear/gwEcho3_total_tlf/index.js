...
//gwEcho3_total_tlf
class GwEcho3_total_tlf extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho3_total_tlf_array = [];

       novo_array.map(function(i){
        gwEcho3_total_tlf_array.push({
                "gwEcho3_total_tlf": i.gwEcho3_total_tlf,
            })
            return gwEcho3_total_tlf_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho3_total_tlf_array_1 = gwEcho3_total_tlf_array.map(a => a.gwEcho3_total_tlf);  
        let gwEcho3_total_tlf_array_2=[];

        j =0;

        for (i=0; i<gwEcho3_total_tlf_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho3_total_tlf_array_2[j]=gwEcho3_total_tlf_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho3_total_tlf",
                            data: gwEcho3_total_tlf_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho3_total_tlf">
...
export default GwEcho3_total_tlf;