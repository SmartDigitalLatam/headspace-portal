...
class BandTemp extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
        axios.get("https://headspace-back.azurewebsites.net/data-santafe").then(res => {
            ...
            for (i=0; i < Dados_array.length; i++ ){
                BandTemp_array[i] = Dados_array[i]['dados']['BandTemp']
              }      
