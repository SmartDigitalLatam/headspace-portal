...
//gwEcho2_system_status
class GwEcho2_system_status extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho2_system_status_array = [];

       novo_array.map(function(i){
        gwEcho2_system_status_array.push({
                "gwEcho2_system_status": i.gwEcho2_system_status,
            })
            return gwEcho2_system_status_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho2_system_status_array_1 = gwEcho2_system_status_array.map(a => a.gwEcho2_system_status);  
        let gwEcho2_system_status_array_2=[];

        j =0;

        for (i=0; i<gwEcho2_system_status_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho2_system_status_array_2[j]=gwEcho2_system_status_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho2_system_status",
                            data: gwEcho2_system_status_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho2_system_status">
...
export default GwEcho2_system_status;