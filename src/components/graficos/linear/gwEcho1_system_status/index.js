...
//gwEcho1_system_status
class GwEcho1_system_status extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho1_system_status_array = [];

       novo_array.map(function(i){
        gwEcho1_system_status_array.push({
                "gwEcho1_system_status": i.gwEcho1_system_status,
            })
            return gwEcho1_system_status_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho1_system_status_array_1 = gwEcho1_system_status_array.map(a => a.gwEcho1_system_status);  
        let gwEcho1_system_status_array_2=[];

        j =0;

        for (i=0; i<gwEcho1_system_status_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho1_system_status_array_2[j]=gwEcho1_system_status_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho1_system_status",
                            data: gwEcho1_system_status_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho1_system_status">
...
export default GwEcho1_system_status;