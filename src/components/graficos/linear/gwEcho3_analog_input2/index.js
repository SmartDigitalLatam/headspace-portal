...
//gwEcho3_analog_input2
class GwEcho3_analog_input2 extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho3_analog_input2_array = [];

       novo_array.map(function(i){
        gwEcho3_analog_input2_array.push({
                "gwEcho3_analog_input2": i.gwEcho3_analog_input2,
            })
            return gwEcho3_analog_input2_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho3_analog_input2_array_1 = gwEcho3_analog_input2_array.map(a => a.gwEcho3_analog_input2);  
        let gwEcho3_analog_input2_array_2=[];

        j =0;

        for (i=0; i<gwEcho3_analog_input2_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho3_analog_input2_array_2[j]=gwEcho3_analog_input2_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho3_analog_input2",
                            data: gwEcho3_analog_input2_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho3_analog_input2">
...
export default GwEcho3_analog_input2;