...
class VFQuality extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
        ...
        axios.get("https://headspace-back.azurewebsites.net/data-santafe").then(res => {
            ...
            for (i=0; i < Dados_array.length; i++ ){
                VFQuality_array[i] = Dados_array[i]['dados']['VFQuality']
              }      
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "VFQuality Santa Fé",
                            data: VFQuality_array,
                            lineTension: 0.1,
                            fill:false,
