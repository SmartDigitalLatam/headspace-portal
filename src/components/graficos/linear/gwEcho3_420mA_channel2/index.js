...
//gwEcho3_420mA_channel2
class GwEcho3_420mA_channel2 extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho3_420mA_channel2_array = [];

       novo_array.map(function(i){
        gwEcho3_420mA_channel2_array.push({
                "gwEcho3_420mA_channel2": i.gwEcho3_420mA_channel2,
            })
            return gwEcho3_420mA_channel2_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho3_420mA_channel2_array_1 = gwEcho3_420mA_channel2_array.map(a => a.gwEcho3_420mA_channel2);  
        let gwEcho3_420mA_channel2_array_2=[];

        j =0;

        for (i=0; i<gwEcho3_420mA_channel2_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho3_420mA_channel2_array_2[j]=gwEcho3_420mA_channel2_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho3_420mA_channel2",
                            data: gwEcho3_420mA_channel2_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho3_420mA_channel2">
...
export default GwEcho3_420mA_channel2;