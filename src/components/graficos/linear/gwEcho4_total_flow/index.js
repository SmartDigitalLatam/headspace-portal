...
//gwEcho4_total_flow
class GwEcho4_total_flow extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho4_total_flow_array = [];

       novo_array.map(function(i){
        gwEcho4_total_flow_array.push({
                "gwEcho4_total_flow": i.gwEcho4_total_flow,
            })
            return gwEcho4_total_flow_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho4_total_flow_array_1 = gwEcho4_total_flow_array.map(a => a.gwEcho4_total_flow);  
        let gwEcho4_total_flow_array_2=[];

        j =0;

        for (i=0; i<gwEcho4_total_flow_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho4_total_flow_array_2[j]=gwEcho4_total_flow_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho4_total_flow",
                            data: gwEcho4_total_flow_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho4_total_flow">
...
export default GwEcho4_total_flow;