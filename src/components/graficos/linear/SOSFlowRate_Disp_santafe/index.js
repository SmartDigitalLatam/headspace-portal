...
class SOSFlowRate_Disp extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
        ...
        axios.get("https://headspace-back.azurewebsites.net/data-santafe").then(res => {
            ...
            let SOSFlowRate_Disp_array=[];
           
              var i =0;
            
            //array SOSFlowRate_Disp
            for (i=0; i < Dados_array.length; i++ ){
                SOSFlowRate_Disp_array[i] = Dados_array[i]['dados']['SOSFlowRate_Disp']
              }
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "SOSFlowRate_Disp Santa Fé",
                            data: SOSFlowRate_Disp_array,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "SOSFlowRate_Disp">
                ...
                <Line
                    ...
                    options={{
                        title:{
                            display: true,
                            text: 'SOSFlowRate_Disp Santa Fé',
                            fontSize: 30
                        },
                        legend:{
                            display:false,
...
export default SOSFlowRate_Disp;