...
//gwEcho2_total_flow
class GwEcho2_total_flow extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho2_total_flow_array = [];

       novo_array.map(function(i){
        gwEcho2_total_flow_array.push({
                "gwEcho2_total_flow": i.gwEcho2_total_flow,
            })
            return gwEcho2_total_flow_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho2_total_flow_array_1 = gwEcho2_total_flow_array.map(a => a.gwEcho2_total_flow);  
        let gwEcho2_total_flow_array_2=[];

        j =0;

        for (i=0; i<gwEcho2_total_flow_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho2_total_flow_array_2[j]=gwEcho2_total_flow_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho2_total_flow",
                            data: gwEcho2_total_flow_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho2_total_flow">
...
export default GwEcho2_total_flow;