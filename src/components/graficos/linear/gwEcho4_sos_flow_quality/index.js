...
//gwEcho4_sos_flow_quality
class GwEcho4_sos_flow_quality extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho4_sos_flow_quality_array = [];

       novo_array.map(function(i){
        gwEcho4_sos_flow_quality_array.push({
                "gwEcho4_sos_flow_quality": i.gwEcho4_sos_flow_quality,
            })
            return gwEcho4_sos_flow_quality_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho4_sos_flow_quality_array_1 = gwEcho4_sos_flow_quality_array.map(a => a.gwEcho4_sos_flow_quality);  
        let gwEcho4_sos_flow_quality_array_2=[];

        j =0;

        for (i=0; i<gwEcho4_sos_flow_quality_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho4_sos_flow_quality_array_2[j]=gwEcho4_sos_flow_quality_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho4_sos_flow_quality",
                            data: gwEcho4_sos_flow_quality_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho4_sos_flow_quality">
...
export default GwEcho4_sos_flow_quality;