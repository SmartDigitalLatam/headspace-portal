...
//gwEcho1_tlf_carry
class GwEcho1_tlf_carry extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho1_tlf_carry_array = [];

       novo_array.map(function(i){
        gwEcho1_tlf_carry_array.push({
                "gwEcho1_tlf_carry": i.gwEcho1_tlf_carry,
            })
            return gwEcho1_tlf_carry_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho1_tlf_carry_array_1 = gwEcho1_tlf_carry_array.map(a => a.gwEcho1_tlf_carry);  
        let gwEcho1_tlf_carry_array_2=[];

        j =0;

        for (i=0; i<gwEcho1_tlf_carry_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho1_tlf_carry_array_2[j]=gwEcho1_tlf_carry_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho1_tlf_carry",
                            data: gwEcho1_tlf_carry_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho1_tlf_carry">
...
export default GwEcho1_tlf_carry;