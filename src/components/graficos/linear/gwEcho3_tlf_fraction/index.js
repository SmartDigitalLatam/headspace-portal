...
//gwEcho3_tlf_fraction
class GwEcho3_tlf_fraction extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho3_tlf_fraction_array = [];

       novo_array.map(function(i){
        gwEcho3_tlf_fraction_array.push({
                "gwEcho3_tlf_fraction": i.gwEcho3_tlf_fraction,
            })
            return gwEcho3_tlf_fraction_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho3_tlf_fraction_array_1 = gwEcho3_tlf_fraction_array.map(a => a.gwEcho3_tlf_fraction);  
        let gwEcho3_tlf_fraction_array_2=[];

        j =0;

        for (i=0; i<gwEcho3_tlf_fraction_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho3_tlf_fraction_array_2[j]=gwEcho3_tlf_fraction_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho3_tlf_fraction",
                            data: gwEcho3_tlf_fraction_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho3_tlf_fraction">
...
export default GwEcho3_tlf_fraction;