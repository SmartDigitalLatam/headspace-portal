...
//gwEcho2_sos_quality
class GwEcho2_sos_quality extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho2_sos_quality",
                            data: gwEcho2_sos_quality_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho2_sos_quality">
...
export default GwEcho2_sos_quality;