...
//gwEcho1_420mA_channel2
class GwEcho1_420mA_channel2 extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho1_420mA_channel2_array = [];

       novo_array.map(function(i){
        gwEcho1_420mA_channel2_array.push({
                "gwEcho1_420mA_channel2": i.gwEcho1_420mA_channel2,
            })
            return gwEcho1_420mA_channel2_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho1_420mA_channel2_array_1 = gwEcho1_420mA_channel2_array.map(a => a.gwEcho1_420mA_channel2);  
        let gwEcho1_420mA_channel2_array_2=[];

        j =0;

        for (i=0; i<gwEcho1_420mA_channel2_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho1_420mA_channel2_array_2[j]=gwEcho1_420mA_channel2_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho1_420mA_channel2",
                            data: gwEcho1_420mA_channel2_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho1_420mA_channel2">
...
export default GwEcho1_420mA_channel2;