...
//gwEcho2_band_temp
class GwEcho2_band_temp extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho2_band_temp_array = [];

       novo_array.map(function(i){
        gwEcho2_band_temp_array.push({
                "gwEcho2_band_temp": i.gwEcho2_band_temp,
            })
            return gwEcho2_band_temp_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho2_band_temp_array_1 = gwEcho2_band_temp_array.map(a => a.gwEcho2_band_temp);  
        let gwEcho2_band_temp_array_2=[];

        j =0;

        for (i=0; i<gwEcho2_band_temp_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho2_band_temp_array_2[j]=gwEcho2_band_temp_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho2_band_temp",
                            data: gwEcho2_band_temp_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho2_band_temp">
...
export default GwEcho2_band_temp;