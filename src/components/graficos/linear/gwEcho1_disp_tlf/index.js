...
//gwEcho1_disp_tlf
class GwEcho1_disp_tlf extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho1_disp_tlf_array = [];

       novo_array.map(function(i){
        gwEcho1_disp_tlf_array.push({
                "gwEcho1_disp_tlf": i.gwEcho1_disp_tlf,
            })
            return gwEcho1_disp_tlf_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho1_disp_tlf_array_1 = gwEcho1_disp_tlf_array.map(a => a.gwEcho1_disp_tlf);  
        let gwEcho1_disp_tlf_array_2=[];

        j =0;

        for (i=0; i<gwEcho1_disp_tlf_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho1_disp_tlf_array_2[j]=gwEcho1_disp_tlf_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho1_disp_tlf",
                            data: gwEcho1_disp_tlf_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho1_disp_tlf">
...
export default GwEcho1_disp_tlf;