...
//gwEcho1_analog_input1
class GwEcho1_analog_input1 extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho1_analog_input1_array = [];

       novo_array.map(function(i){
        gwEcho1_analog_input1_array.push({
                "gwEcho1_analog_input1": i.gwEcho1_analog_input1,
            })
            return gwEcho1_analog_input1_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho1_analog_input1_array_1 = gwEcho1_analog_input1_array.map(a => a.gwEcho1_analog_input1);  
        let gwEcho1_analog_input1_array_2=[];

        j =0;

        for (i=0; i<gwEcho1_analog_input1_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho1_analog_input1_array_2[j]=gwEcho1_analog_input1_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho1_analog_input1",
                            data: gwEcho1_analog_input1_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho1_analog_input1">
...
export default GwEcho1_analog_input1;