...
//gwEcho3_sos_flow_rate
class GwEcho3_sos_flow_rate extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho3_sos_flow_rate_array = [];

       novo_array.map(function(i){
        gwEcho3_sos_flow_rate_array.push({
                "gwEcho3_sos_flow_rate": i.gwEcho3_sos_flow_rate,
            })
            return gwEcho3_sos_flow_rate_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho3_sos_flow_rate_array_1 = gwEcho3_sos_flow_rate_array.map(a => a.gwEcho3_sos_flow_rate);  
        let gwEcho3_sos_flow_rate_array_2=[];

        j =0;

        for (i=0; i<gwEcho3_sos_flow_rate_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho3_sos_flow_rate_array_2[j]=gwEcho3_sos_flow_rate_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho3_sos_flow_rate",
                            data: gwEcho3_sos_flow_rate_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho3_sos_flow_rate">
...
export default GwEcho3_sos_flow_rate;