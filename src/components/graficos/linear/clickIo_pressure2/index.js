...
class ClickIo_pressure2 extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let clickIo_pressure2_array = [];

       novo_array.map(function(i){
        clickIo_pressure2_array.push({
                "clickIo_pressure2": i.clickIo_pressure2,
            })
            return clickIo_pressure2_array;
        })
       ...
       //manipulando o array de dados
        let clickIo_pressure2_array_1 = clickIo_pressure2_array.map(a => a.clickIo_pressure2);  
        let clickIo_pressure2_array_2=[];

        j =0;

        for (i=0; i<clickIo_pressure2_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                clickIo_pressure2_array_2[j]=clickIo_pressure2_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "clickIo_pressure2",
                            data: clickIo_pressure2_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "clickIo_pressure2">
...
export default ClickIo_pressure2;