...
//gwEcho3_flow_rate
class GwEcho3_flow_rate extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho3_flow_rate",
                            data: gwEcho3_flow_rate_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho3_flow_rate">
...
export default GwEcho3_flow_rate;