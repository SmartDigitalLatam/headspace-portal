...
//gwEcho3_pressure
class GwEcho3_pressure extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho3_pressure_array = [];

       novo_array.map(function(i){
        gwEcho3_pressure_array.push({
                "gwEcho3_pressure": i.gwEcho3_pressure,
            })
            return gwEcho3_pressure_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho3_pressure_array_1 = gwEcho3_pressure_array.map(a => a.gwEcho3_pressure);  
        let gwEcho3_pressure_array_2=[];

        j =0;

        for (i=0; i<gwEcho3_pressure_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho3_pressure_array_2[j]=gwEcho3_pressure_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho3_pressure",
                            data: gwEcho3_pressure_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho3_pressure">
...
export default GwEcho3_pressure;