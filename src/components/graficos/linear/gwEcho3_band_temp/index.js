...
//gwEcho3_band_temp
class GwEcho3_band_temp extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho3_band_temp_array = [];

       novo_array.map(function(i){
        gwEcho3_band_temp_array.push({
                "gwEcho3_band_temp": i.gwEcho3_band_temp,
            })
            return gwEcho3_band_temp_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho3_band_temp_array_1 = gwEcho3_band_temp_array.map(a => a.gwEcho3_band_temp);  
        let gwEcho3_band_temp_array_2=[];

        j =0;

        for (i=0; i<gwEcho3_band_temp_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho3_band_temp_array_2[j]=gwEcho3_band_temp_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho3_band_temp",
                            data: gwEcho3_band_temp_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho3_band_temp">
...
export default GwEcho3_band_temp;