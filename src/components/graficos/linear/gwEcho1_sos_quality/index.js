...
//gwEcho1_sos_quality
class GwEcho1_sos_quality extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho1_sos_quality",
                            data: gwEcho1_sos_quality_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho1_sos_quality">
...
export default GwEcho1_sos_quality;