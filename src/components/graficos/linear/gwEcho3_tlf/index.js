...
//gwEcho3_tlf
class GwEcho3_tlf extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho3_tlf_array = [];

       novo_array.map(function(i){
        gwEcho3_tlf_array.push({
                "gwEcho3_tlf": i.gwEcho3_tlf,
            })
            return gwEcho3_tlf_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho3_tlf_array_1 = gwEcho3_tlf_array.map(a => a.gwEcho3_tlf);  
        let gwEcho3_tlf_array_2=[];

        j =0;

        for (i=0; i<gwEcho3_tlf_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho3_tlf_array_2[j]=gwEcho3_tlf_array_1[i];
                    j = j+1;
            } else {
            }
        }
