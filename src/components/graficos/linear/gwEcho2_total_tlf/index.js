...
//gwEcho2_total_tlf
class GwEcho2_total_tlf extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho2_total_tlf_array = [];

       novo_array.map(function(i){
        gwEcho2_total_tlf_array.push({
                "gwEcho2_total_tlf": i.gwEcho2_total_tlf,
            })
            return gwEcho2_total_tlf_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho2_total_tlf_array_1 = gwEcho2_total_tlf_array.map(a => a.gwEcho2_total_tlf);  
        let gwEcho2_total_tlf_array_2=[];

        j =0;

        for (i=0; i<gwEcho2_total_tlf_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho2_total_tlf_array_2[j]=gwEcho2_total_tlf_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho2_total_tlf",
                            data: gwEcho2_total_tlf_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho2_total_tlf">
...
export default GwEcho2_total_tlf;