...
class TotalFlow extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
        ...
        axios.get("https://headspace-back.azurewebsites.net/data-santafe").then(res => {
            ...
            for (i=0; i < Dados_array.length; i++ ){
                TotalFlow_array[i] = Dados_array[i]['dados']['TotalFlow']
              }       
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "Total Flow Santa Fé (L/min)",
                            data: TotalFlow_array,
                            lineTension: 0.1,
                            fill:false,
            ...
            <div className = "TotalFlow">
                ...
                <Line
                    ...
                    options={{
                        title:{
                            display: true,
                            text: 'Total Flow Santa Fé (L/min)',
                            fontSize: 30
                        },
                        legend:{
                            display:false,
