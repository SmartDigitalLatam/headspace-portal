...
class ClickIo_pressure3 extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let clickIo_pressure3_array = [];

       novo_array.map(function(i){
        clickIo_pressure3_array.push({
                "clickIo_pressure3": i.clickIo_pressure3,
            })
            return clickIo_pressure3_array;
        })
       ...
       //manipulando o array de dados
        let clickIo_pressure3_array_1 = clickIo_pressure3_array.map(a => a.clickIo_pressure3);  
        let clickIo_pressure3_array_2=[];

        j =0;

        for (i=0; i<clickIo_pressure3_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                clickIo_pressure3_array_2[j]=clickIo_pressure3_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "clickIo_pressure3",
                            data: clickIo_pressure3_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "clickIo_pressure3">
...
export default ClickIo_pressure3;