...
//gwEcho2_flow_quality
class GwEcho2_flow_quality extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho2_flow_quality_array = [];

       novo_array.map(function(i){
        gwEcho2_flow_quality_array.push({
                "gwEcho2_flow_quality": i.gwEcho2_flow_quality,
            })
            return gwEcho2_flow_quality_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho2_flow_quality_array_1 = gwEcho2_flow_quality_array.map(a => a.gwEcho2_flow_quality);  
        let gwEcho2_flow_quality_array_2=[];

        j =0;

        for (i=0; i<gwEcho2_flow_quality_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho2_flow_quality_array_2[j]=gwEcho2_flow_quality_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho2_flow_quality",
                            data: gwEcho2_flow_quality_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho2_flow_quality">
...
export default GwEcho2_flow_quality;