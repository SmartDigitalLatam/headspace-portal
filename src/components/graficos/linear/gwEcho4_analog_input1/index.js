...
//gwEcho4_analog_input1
class GwEcho4_analog_input1 extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho4_analog_input1_array = [];

       novo_array.map(function(i){
        gwEcho4_analog_input1_array.push({
                "gwEcho4_analog_input1": i.gwEcho4_analog_input1,
            })
            return gwEcho4_analog_input1_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho4_analog_input1_array_1 = gwEcho4_analog_input1_array.map(a => a.gwEcho4_analog_input1);  
        let gwEcho4_analog_input1_array_2=[];

        j =0;

        for (i=0; i<gwEcho4_analog_input1_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho4_analog_input1_array_2[j]=gwEcho4_analog_input1_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho4_analog_input1",
                            data: gwEcho4_analog_input1_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho4_analog_input1">
...
export default GwEcho4_analog_input1;