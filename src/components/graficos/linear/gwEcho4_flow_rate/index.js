...
//gwEcho4_flow_rate
class GwEcho4_flow_rate extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho4_flow_rate",
                            data: gwEcho4_flow_rate_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho4_flow_rate">
...
export default GwEcho4_flow_rate;