...
//gwEcho3_flow_carry
class GwEcho3_flow_carry extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho3_flow_carry_array = [];

       novo_array.map(function(i){
        gwEcho3_flow_carry_array.push({
                "gwEcho3_flow_carry": i.gwEcho3_flow_carry,
            })
            return gwEcho3_flow_carry_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho3_flow_carry_array_1 = gwEcho3_flow_carry_array.map(a => a.gwEcho3_flow_carry);  
        let gwEcho3_flow_carry_array_2=[];

        j =0;

        for (i=0; i<gwEcho3_flow_carry_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho3_flow_carry_array_2[j]=gwEcho3_flow_carry_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho3_flow_carry",
                            data: gwEcho3_flow_carry_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho3_flow_carry">
...
export default GwEcho3_flow_carry;