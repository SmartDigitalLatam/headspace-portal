...
class TLF_Disp extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
        axios.get("https://headspace-back.azurewebsites.net/data-santafe").then(res => {
            ...
            for (i=0; i < Dados_array.length; i++ ){
                TLF_Disp_array[i] = Dados_array[i]['dados']['TLF_Disp']
              }
    ...
    render(){
        return(
            <div className = "True Liquid Flow Disp Santa Fé (L/min)">
                ...
                <Line
                    ...
                    options={{
                        title:{
                            display: true,
                            text: 'True Liquid Flow Disp Santa Fé (L/min)',
                            fontSize: 30
                        },
                        legend:{
                            display:false,
