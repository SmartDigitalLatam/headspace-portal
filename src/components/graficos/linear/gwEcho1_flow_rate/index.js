...
//gwEcho1_flow_rate
class GwEcho1_flow_rate extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho1_flow_rate",
                            data: gwEcho1_flow_rate_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho1_flow_rate">
...
export default GwEcho1_flow_rate;