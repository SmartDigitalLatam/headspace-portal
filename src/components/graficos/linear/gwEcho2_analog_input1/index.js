...
//gwEcho2_analog_input1
class GwEcho2_analog_input1 extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("http://localhost:3000/headspace_dev1").then(res => {
        ...
        let gwEcho2_analog_input1_array = [];

       novo_array.map(function(i){
        gwEcho2_analog_input1_array.push({
                "gwEcho2_analog_input1": i.gwEcho2_analog_input1,
            })
            return gwEcho2_analog_input1_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho2_analog_input1_array_1 = gwEcho2_analog_input1_array.map(a => a.gwEcho2_analog_input1);  
        let gwEcho2_analog_input1_array_2=[];

        j =0;

        for (i=0; i<gwEcho2_analog_input1_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho2_analog_input1_array_2[j]=gwEcho2_analog_input1_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho2_analog_input1",
                            data: gwEcho2_analog_input1_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho2_analog_input1">
...
export default GwEcho2_analog_input1;