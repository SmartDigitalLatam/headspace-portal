...
//gwEcho2_pressure
class GwEcho2_pressure extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho2_pressure_array = [];

       novo_array.map(function(i){
        gwEcho2_pressure_array.push({
                "gwEcho2_pressure": i.gwEcho2_pressure,
            })
            return gwEcho2_pressure_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho2_pressure_array_1 = gwEcho2_pressure_array.map(a => a.gwEcho2_pressure);  
        let gwEcho2_pressure_array_2=[];

        j =0;

        for (i=0; i<gwEcho2_pressure_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho2_pressure_array_2[j]=gwEcho2_pressure_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho2_pressure",
                            data: gwEcho2_pressure_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho2_pressure">
...
export default GwEcho2_pressure;