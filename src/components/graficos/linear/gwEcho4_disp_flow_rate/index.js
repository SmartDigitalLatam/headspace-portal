...
//gwEcho4_disp_flow_rate
class GwEcho4_disp_flow_rate extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let gwEcho4_disp_flow_rate_array = [];

       novo_array.map(function(i){
        gwEcho4_disp_flow_rate_array.push({
                "gwEcho4_disp_flow_rate": i.gwEcho4_disp_flow_rate,
            })
            return gwEcho4_disp_flow_rate_array;
        })
       ...
       //manipulando o array de dados
        let gwEcho4_disp_flow_rate_array_1 = gwEcho4_disp_flow_rate_array.map(a => a.gwEcho4_disp_flow_rate);  
        let gwEcho4_disp_flow_rate_array_2=[];

        j =0;

        for (i=0; i<gwEcho4_disp_flow_rate_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                gwEcho4_disp_flow_rate_array_2[j]=gwEcho4_disp_flow_rate_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "gwEcho4_disp_flow_rate",
                            data: gwEcho4_disp_flow_rate_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "gwEcho4_disp_flow_rate">
...
export default GwEcho4_disp_flow_rate;