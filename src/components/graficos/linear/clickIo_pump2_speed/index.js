...
class ClickIo_pump2_speed extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
    ...
    getChartData(){
       ...
       axios.get("https://headspace-back.azurewebsites.net/headspace_dev1").then(res => {
        ...
        let clickIo_pump2_speed_array = [];

       novo_array.map(function(i){
        clickIo_pump2_speed_array.push({
                "clickIo_pump2_speed": i.clickIo_pump2_speed,
            })
            return clickIo_pump2_speed_array;
        })
       ...
       //manipulando o array de dados
        let clickIo_pump2_speed_array_1 = clickIo_pump2_speed_array.map(a => a.clickIo_pump2_speed);  
        let clickIo_pump2_speed_array_2=[];

        j =0;

        for (i=0; i<clickIo_pump2_speed_array_1.length;i++){
            if (property_array_1[i]==="telemetry"){
                clickIo_pump2_speed_array_2[j]=clickIo_pump2_speed_array_1[i];
                    j = j+1;
            } else {
            }
        }
        ...
        //plotagem dos arrays limpos
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "clickIo_pump2_speed",
                            data: clickIo_pump2_speed_array_2,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "clickIo_pump2_speed">
...
export default ClickIo_pump2_speed;