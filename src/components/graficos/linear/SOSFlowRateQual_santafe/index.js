...
class SOSFlowRateQual extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
        ...
        axios.get("https://headspace-back.azurewebsites.net/data-santafe").then(res => {
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "SOSFlowRateQual Santa Fé",
                            data: SOSFlowRateQual_array,
                            lineTension: 0.1,
                            fill:false,
...
export default SOSFlowRateQual;